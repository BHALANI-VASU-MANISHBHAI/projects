...
const Login = () => {
  ...
  return (
    <form  onSubmit={onSubmitHandler} className='flex flex-col items-center w-[90%] sm:max-w-96 m-auto mt-14 gap-4 trxt-gray-800'   action="">
       ...
       {currentState=='Login'?'' : <input type="text"  className='w-full px-3 py-2 border border-gray-800' placeholder='Name' name="" id="Name"  required/>}
       <input type="Email"  className='w-full px-3 py-2 border border-gray-800' placeholder='Email' name="" id="Email" required/>
       <input type="password"  className='w-full px-3 py-2 border border-gray-800' placeholder='Password' name="Pasword" id="" required/>
