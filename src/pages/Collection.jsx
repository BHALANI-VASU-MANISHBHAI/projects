...
}, [category, subCategory, products, sortValue]);
    ...
    return (
      <div className='flex  flex-col sm:flex-row gap-1 sm:gap-10 pt-10 border-t'>
        ...
        <div className='min-w-60'>
          ...
          <div className={` border border-gray-300 pb-4 pl-4 mt-6 ${showFilter ? '' : 'hidden'}`}>
            ...
            <div className='flex flex-col  text-sm font-light text-gray-700'>
              <p className='flex gap-2'>
                <input type="checkbox" className='mt-0.9' value={'Men'}  onChange={handleCategory}/> Men
              </p>
              <p className='flex gap-2'>
                <input type="checkbox" className='mt-0.9' value={'Women'} onChange={handleCategory} /> Women
              </p>
              <p className='flex gap-2'>
                <input type="checkbox" className='mt-0.9' value={'Kids'} onChange={handleCategory} /> Kids
              </p>
            </div>
          </div>
          {/* SubCategary */}
          <div className={` border border-gray-300 pb-4 pl-4 mt-6 ${showFilter ? '' : 'hidden'}`}>
            ...
            <div className='flex flex-col gap-2 text-sm font-light text-gray-700'>
              <p className='flex gap-2'>
                <input type="checkbox" className='mt-0.9' value={'Topwear'}  onChange={handleSubCategory}/> TopWear
              </p>
              <p className='flex gap-2'>
                <input type="checkbox" className='mt-0.9' value={'Bottomwear'}  onChange={handleSubCategory}/> BottomWear
              </p>
              <p className='flex gap-2'>
                <input type="checkbox" className='mt-0.9' value={'Winterwear'}   onChange={handleSubCategory}/> WinterWear
              </p>
            </div>
          </div>
          {/*SubCategary END */}
        ...
        <div>
          ...
          <select className='border border-gray-300 rounded-md p-2 text-sm font-light mb-3 ' onChange={SortProduct}>
